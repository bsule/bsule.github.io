...
function AboutPicture() {
    ...
    return (
        <AnimatePresence>
            ...
            <motion.div className='fixed absolute right-0 lg:pt-40 xl:pt-24 2xl:pt-16' initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0, transition: {duration: .5}}}>
                <img src={picArr[arrLocation]} alt="Error loading picture" className='rounded-l-lg xl:w-[400px] lg:w-[460px] w-[300px]'/>
            </motion.div>
            )}
        </AnimatePresence>
    );
