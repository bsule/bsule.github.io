...
function About() {
    return (
        <div className='flex justify-center'>
            <motion.div className="text-3xl fixed w-3/5 text-lg" initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0, transition: {duration: .5}}}>
                <p className='mt-20'>
                    ...
                    Over the last three summers, I've interned at <a href="https://msasosoftware.com/" target='blank'><span className='link link-underline font-semibold'>MSASO Software and Consulting LLC</span></a>
